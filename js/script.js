...
(function () {
  ...
  const translations = {
    ...
    en: {
      ...
      servicesDesc: 'From traditional oil massages to specialized pain-relief treatments — every service is designed with personalized care and attention.',
      svc1Title: 'Traditional Oil Massage',
      svc1Desc: 'Authentic Sri Lankan oil massage using warm herbal oils for deep relaxation and wellness.',
      svc2Title: 'Head Massage',
      svc2Desc: 'Specialized scalp therapy to relieve tension, headaches, and daily stress.',
      svc3Title: 'Foot Therapy',
      svc3Desc: 'Reflexology-based foot treatments to improve circulation and provide relaxation.',
      svc4Title: 'Neck & Shoulder Therapy',
      svc4Desc: 'Targeted therapy for office-related stress, stiffness, and muscle tension.',
      svcContact: 'Learn More →',
