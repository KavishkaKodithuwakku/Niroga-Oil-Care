...
(function () {
  ...
  const translations = {
    si: {
      ...
      svc1Desc: 'ඖෂධීය උණුසුම් තෙල් භාවිතයෙන් සිදුකරන සම්පූර්ණ ශරීර සම්බාහන ප්‍රතිකාරයකි. මාංශ පේශී ආතතිය අඩු කර ගැඹුරු විවේකයක් ලබා දෙයි.',
      svc1Benefit1: 'මාංශ පේශී වේදනා අඩු කරයි',
      svc1Benefit2: 'රුධිර සංසරණය වැඩිදියුණු කරයි',
      svc1Benefit3: 'ආතතිය සහ මානසික පීඩනය අඩු කරයි',
      svc1Benefit4: 'ශරීරයට ගැඹුරු විවේකයක් ලබා දෙයි',
      svc1Price: 'Starting from Rs. 4,500',

      svc2Title: 'Head Massage',
      svc2Duration: '45 Minutes',
      svc2Desc: 'හිස සහ හිස්කබල සඳහා විශේෂයෙන් නිර්මාණය කළ ප්‍රතිකාරයකි. ආතතිය, හිසරදය සහ දෛනික වෙහෙස අඩු කිරීමට උපකාරී වේ.',
      svc2Benefit1: 'හිසරදය අඩු කිරීමට උපකාරී වේ',
      svc2Benefit2: 'හිස්කබලේ ආතතිය අඩු කරයි',
      svc2Benefit3: 'මානසික සන්සුන්භාවය ලබා දෙයි',
      svc2Benefit4: 'නින්දේ ගුණාත්මකභාවය වැඩි කරයි',
      svc2Price: 'Starting from Rs. 3,200',

      svc3Title: 'Foot Therapy',
      svc3Duration: '60 Minutes',
      svc3Desc: 'පාද සම්බන්ධ reflexology ක්‍රමවේද භාවිතා කරමින් ශරීරයේ ශක්ති සමතුලිතතාවය සහ සුවතාවය වැඩිදියුණු කරන ප්‍රතිකාරයකි.',
      svc3Benefit1: 'පාද වේදනා සහ වෙහෙස අඩු කරයි',
      svc3Benefit2: 'රුධිර සංසරණය වැඩිදියුණු කරයි',
      svc3Benefit3: 'ශරීරයේ සමතුලිතතාවය වැඩි කරයි',
      svc3Benefit4: 'ආතතිය අඩු කරයි',
      svc3Price: 'Starting from Rs. 3,700',

      svc4Title: 'Steam Bath',
      svc4Duration: '90 Minutes',
      svc4Desc: 'උණුසුම් වාෂ්ප ප්‍රතිකාරයක් මගින් ශරීරයේ තදබදය සහ මාංශ පේශී ආතතිය අඩු කරන සුවතා ප්‍රතිකාරයකි.',
      svc4Benefit1: 'ශරීරයේ තදබදය අඩු කරයි',
      svc4Benefit2: 'මාංශ පේශී ලිහිල් කරයි',
      svc4Benefit3: 'ශරීරයේ චලනය පහසු කරයි',
      svc4Benefit4: 'සම්පූර්ණ විවේකයක් ලබා දෙයි',
      svc4Price: 'Starting from Rs. 4,800',
    ...
    en: {
      ...
      svc1Title: 'Full Body Massage',
      svc1Duration: '60 Minutes',
      svc1Desc: 'A complete body massage using warm herbal oils to reduce muscle tension, improve relaxation, and restore body balance.',
      svc1Benefit1: 'Reduces muscle tension',
      svc1Benefit2: 'Improves blood circulation',
      svc1Benefit3: 'Relieves stress',
      svc1Benefit4: 'Promotes deep relaxation',
      svc1Price: 'Starting from Rs. 4,500',


      svc2Title: 'Head Massage',
      svc2Duration: '45 Minutes',
      svc2Desc: 'A specialized scalp therapy designed to reduce headaches, mental stress, and daily tension while improving relaxation.',
      svc2Benefit1: 'Reduces headaches',
      svc2Benefit2: 'Relieves scalp tension',
      svc2Benefit3: 'Improves mental relaxation',
      svc2Benefit4: 'Supports better sleep',
      svc2Price: 'Starting from Rs. 3,200',


      svc3Title: 'Foot Therapy',
      svc3Duration: '60 Minutes',
      svc3Desc: 'A reflexology-based foot treatment that improves circulation, reduces fatigue, and restores body energy balance.',
      svc3Benefit1: 'Reduces foot fatigue',
      svc3Benefit2: 'Improves circulation',
      svc3Benefit3: 'Enhances body balance',
      svc3Benefit4: 'Relieves stress',
      svc3Price: 'Starting from Rs. 3,700',


      svc4Title: 'Steam Bath',
      svc4Duration: '90 Minutes',
      svc4Desc: 'A relaxing steam treatment designed to release stiffness, relax muscles, and improve overall body comfort.',
      svc4Benefit1: 'Reduces body stiffness',
      svc4Benefit2: 'Relaxes muscles',
      svc4Benefit3: 'Improves mobility',
      svc4Benefit4: 'Provides complete relaxation',
      svc4Price: 'Starting from Rs. 4,800',
